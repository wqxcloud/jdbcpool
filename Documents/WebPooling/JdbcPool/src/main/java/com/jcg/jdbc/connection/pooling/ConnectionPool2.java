...
public class ConnectionPool2 {
	...
	static final String JDBC_DRIVER = "org.mongodb.driver";  
	static final String JDBC_DB_URL = "mongodb://localhost:27017/tutorialDb"; 

	// JDBC Database Credentials
	static final String JDBC_USER = "root";
	static final String JDBC_PASS = "1596324780a";
	...
	public static void main(String[] args) {
		...
		ConnectionPool2 jdbcObj = new ConnectionPool2();
		try {	
